...
Scenario Outline: Save Grocery information
	...
	| "burger" | "5" | "10000" | "Halloumi aubergine burgers with harissa relish" |  "1 tbsp soft brown sugar" | "2 onions, very finely sliced" |
...
Scenario Outline: Crossed out grocery items
	...
	| "burger" | "5" | "10000" | "2 onions, very finely sliced" |
...
Scenario Outline: Saving Recipes to a list
	...
	| "burger" | "5" | "10000" | "Halloumi aubergine burgers with harissa relish" |  "Favorite" |
...
Scenario Outline: Reorder recipe in a list
	...
	| "burger" | "5" | "10000" | "Halloumi aubergine burgers with harissa relish" | "Grilled Monterey Jack Turkey Burger with Peaches and Blueberries" |
